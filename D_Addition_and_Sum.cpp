...
#define rnode (node * 2 + 2)
    ...
    void update(ll l, ll r, ll val, ll node, ll start, ll end)
    {
        ...
        tree[node].first = tree[lnode].first + tree[lnode].second * (mid - start + 1) +
                           tree[rnode].first + tree[rnode].second * (end - mid);
    }
    ...
    ll rfind(ll l, ll r, ll node, ll start, ll end)
    {
        ...
        {
            return tree[node].first + tree[node].second * (end - start + 1);
        }
        tree[lnode].second += tree[node].second;
        tree[rnode].second += tree[node].second;
        tree[node].second = 0;
