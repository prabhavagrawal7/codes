...
/* -------------------------------------------------------------------------------------------------------------------------------------------------------- */
void dfs(ll x, vi &vis, vvi &g, vi &prefix, vi &a, vi &b, vi &ans)
{
    vis[x] = true;
    foreach (i, g[x])
    {
        ...
        ans[i] = upper_bound(all(prefix), a[i]) - prefix.begin() - 1;
        dfs(i, vis, g, prefix, a, b, ans);
        prefix.pop_back();
    }
}
void func()
