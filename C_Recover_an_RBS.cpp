...
/* -------------------------------------------------------------------------------------------------------------------------------------------------------- */
void limiter(set<ll> &ss)
{
    if (ss.size() && *ss.begin() < 0)
    {
        if (ss.size() == 1 || *ss.rbegin() < 0)
        {
            ss.clear();
        }
        else
...
void func()
{
    ...
    if (dup.size() && btn(*dup.begin(), 0LL, *dup.rbegin()))
    {
        give("NO");
    }
    if (btn(*notdup.begin(), 0LL, *notdup.rbegin()))
    {
        give("YES");
    }
    give("NO");
