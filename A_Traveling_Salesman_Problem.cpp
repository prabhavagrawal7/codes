...
void func()
{
    ...
    range(n)
    {
        newint(a, b);
        if (a > 0)
            farthest[0] = max(farthest[0], a);
        if (a < 0)
            farthest[1] = min(farthest[1], a);
        if (b > 0)
            farthest[2] = max(farthest[2], b);
        if (b < 0)
            farthest[3] = min(farthest[3], b);
    }
    print(2 * (farthest[0] - farthest[1] + farthest[2] - farthest[3]));
}
int main()
{
