...
vi partialans(string &str, vi &vec, vvi &graph)
{
    // kisi bhi ek component ko pakad kr jab tak visited mark 2 nahi ho jate sab ke sab tab tak nahi rukna hai
...
void func()
{
    ...
    range(i, n)
    {
        parent[find(i)] = parent[find(vec[i])];
    }
