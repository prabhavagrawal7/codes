...
void func()
{
    ...
    range(i, 3)
    {
        range(j, 3)
        {
            range(k, 3)
            {
                if (store[0][i].second == store[1][j].second ||
                    store[0][i].second == store[2][k].second ||
                    store[1][j].second == store[2][k].second)
                    continue;
                ans = max(ans, store[0][i].first + store[1][j].first + store[2][k].first);
            }
        }
    }
    print(ans);
