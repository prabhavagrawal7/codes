...
ll func()
{
    ...
    range(i, 5)
    {
        range(j, i + 1, 5)
        {
            ...
            range(k, n)
            {
                if (newstore[i][k] == 0 && newstore[j][k] == 0)
                {
                    flag = false;
                    break;
                }
                else if (newstore[i][k] == 1 && newstore[j][k] == 1)
                    buffer++;
                else if (newstore[i][k] == 1 && newstore[j][k] == 0)
                    sum--;
                else if (newstore[i][k] == 0 && newstore[j][k] == 1)
                    sum++;
            }
            if (flag)
            {
