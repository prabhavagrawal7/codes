...
public:
    ...
    template <typename T, typename = typename enable_if<is_arithmetic<T>::value || is_rll<T>::value, T>::type>
    ...
    inline rll operator-=(T a) { return *this = *this - rll(a); }
    template <typename T, typename = typename enable_if<is_arithmetic<T>::value || is_rll<T>::value, T>::type>
    inline rll operator*=(T a) { return this->val = this->val * rll(a); }
    template <typename T, typename = typename enable_if<is_arithmetic<T>::value || is_rll<T>::value, T>::type>
    inline rll operator/=(T a) { return *this = *this / rll(a); }
    template <typename T, typename = typename enable_if<is_arithmetic<T>::value || is_rll<T>::value, T>::type>
    inline rll operator>>=(T a) { return *this = *this >> rll(a); }
