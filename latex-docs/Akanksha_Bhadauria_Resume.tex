...
\usepackage{multirow}
\thispagestyle{empty}
\geometry{paperheight=11in, paperwidth=8.5in, margin=0.6cm}
...
\begin{itemize}[leftmargin=20px,topsep=1pt,itemsep=1.5pt,partopsep=1pt, parsep=1pt]
	...
	\item Used Machine learning techniques using Python, Pandas, Scikit-Learn, Matplotlib, and Seaborn.
...
\begin{itemize}[leftmargin=15px, topsep=1pt,itemsep=2pt,partopsep=2pt, parsep=2pt]
