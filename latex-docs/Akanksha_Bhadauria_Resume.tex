...
\begin{itemize}[leftmargin=20px,topsep=0pt,itemsep=1pt,partopsep=1pt, parsep=1pt]
	\item Developed a full dummy shop app that allows users to browse and purchase items online, similar to Amazon.
	\item Implemented user authentication and authorization using Django's built-in authentication system
	\item Implemented a database to store information about products, orders, and users.
	\item Enhanced the user experience by integrating a payment gateway.
\end{itemize}
...
\subsection*{\href{https://github.com/Akanksha2403/no_issues}{Grievance Addressal System}}~ Django $\vert$ Data Structures $\vert$ CSS $\vert$ JavaScript $\vert$ Bootstrap  \\ 
\begin{itemize}[leftmargin=20px,topsep=0pt,itemsep=1pt,partopsep=1pt, parsep=1pt]
...
\begin{itemize}[leftmargin=15px, topsep=0pt,itemsep=2pt,partopsep=2pt, parsep=2pt]
