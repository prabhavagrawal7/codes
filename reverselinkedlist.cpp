...
public:
    ...
    void checking()
    {
        ListNode* head;head->val = 1;
        ListNode* a1; a1->val = 2; a1->next = head;
        ListNode* a2; a2->val = 2; a2->next = a1;
        ListNode* a3; a3->val = 2; a3->next = a2;
        ListNode* a4; a4->val = 2; a4->next = a3;
